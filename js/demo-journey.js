/* Template Factory - FRG live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-frg-tustin/';
  var LS_CHANGES = 'tf_frg_change_log_v1';
  var LS_PURCHASED = 'tf_frg_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Kitchen remodeling, bathroom remodeling, tile, and countertops or backsplash across Tustin and Orange County. Fixed itemised quotes before we start, Jose as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
      ...
      apply: function () {
        if (heroH) {
          heroH.innerHTML = 'Tile, kitchens,<br>and baths,<br>quoted <em>before</em> we start.';
        }
      }
    },
    {
      ...
      apply: function () {
        if (serviceFirst) {
          serviceFirst.textContent = 'Kitchen remodeling (written programme)';
        }
      }
    }
  ];
  ...
  function setBarMode(mode) {
    ...
    if (mode === 'updated') {
      ...
      barSub.textContent = 'Draft for Jose at FRG. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for FRG. Hang tight.',
        delay,
        function () {
