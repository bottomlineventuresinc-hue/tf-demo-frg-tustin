/* Template Factory - FRG Tile Remodeling Co live demo journey.
...
(function () {
  ...
  var demoEdits = [
    ...
    },
    {
      ...
      apply: function () {
        if (heroH) {
          heroH.innerHTML = 'Tile, kitchens, and baths,<br>priced <em>first.</em>';
        }
      }
    },
    {
      ...
      apply: function () {
        if (serviceFirst) {
          serviceFirst.textContent = 'Tile installation (written price)';
        }
      }
    }
  ];
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Jose at FRG Tile Remodeling Co. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Jose at FRG Tile Remodeling Co. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for FRG Tile Remodeling Co. Hang tight.',
        delay,
        function () {
